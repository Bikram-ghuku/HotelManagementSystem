...
from sql.manager import makeRoomReservation
...
def makeResrvation(parent):
    ...
    canvas.create_text(51.0,24.0,anchor="nw",text="Make Room Reservation:",fill="#1AA2EC",font=("Saira Condensed Bold", 50 * -1))

    global button_image_1
    button_image_1 = PhotoImage(file=relative_to_assets("button_1.png"))
    button_1 = Button(image=button_image_1,borderwidth=0,highlightthickness=0,command=lambda: makeRoomReservation(entry_1.get(), entry_6.get(), entry_5.get(), entry_2.get(), entry_3.get(), entry_4.get()),relief="flat")
    ...
    canvas.create_text(616.0,264.0,anchor="nw",text="Booking Date:",fill="#000000",font=("Saira Condensed Bold", 25 * -1))
